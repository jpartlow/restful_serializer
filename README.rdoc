...
Example configuration (config/initializers/restful.rb:
  ...
  Restful.register_web_service('Foo Web Service') do |config|
    ...
    # This is the url prefix used for calls to the web service.  It defaults to the web service name, but
    # can be set to be something different, or to nil, if you're web service has no base uri and named_routes
